...
class MyWindow:
    def __init__(self, win):
        ...
        self.clrbutton = Button(win, text='Clear All', font='Calibri', command=self.clearField, background='green')
        self.clrbutton.place(x=100, y=250)
...
window = Tk()
MyWindow(window)
window.title('Helllo Python')
window.geometry("400x300+750+250")
window.mainloop()